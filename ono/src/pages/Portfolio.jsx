...
const Portfolio = () => {
  ...
  return (
    <div className="leading-[100%] bg-[#F5F5F5] min-h-screen">
      <div className="sticky z-[50] top-0 left-0 right-0 flex flex-col gap-2 font-inter max-w-md mx-auto py-4 bg-white border-b">
        <h1 className="text-xl font-[500] text-[#2C2D32] mx-auto">
          My Portfolio
        </h1>
      </div>
      <div className="bg-[#F5F5F5] px-4 pb-4 max-w-md mx-auto">
        <Tabs
          className="w-full font-[500] text-xs"
          value={status}
          onValueChange={handleTabChange}
        >
          <div className="w-full sticky top-[60.7px] py-4 left-0 right-0 bg-[#F5F5F5] z-[50] px-4">
            <TabsList className="w-full rounded-full space-x-2 bg-transparent text-[#2C2D32] p-0 h-8">
              <TabsTrigger
                value="open"
                className="w-full py-2.5 space-x-2 rounded-full border bg-white data-[state=active]:text-[#EFF0FF] data-[state=active]:bg-[#2C2D32] text-[13px] font-light h-auto"
              >
                <span>
                  <img
                    src={
              ...
              <TabsTrigger
                value="closed"
                className="w-full py-2.5 space-x-2 rounded-full border bg-white data-[state=active]:text-[#EFF0FF] data-[state=active]:bg-[#2C2D32] text-[13px] font-light"
              >
                <span>
                  <img
                    src={
          ...
          <TabsContent value="open">
            <div className="bg-[#F5F5F5] pb-4 pt-2 max-w-md mx-auto relative px-4">
              <div className="bg-white p-4 flex flex-col font-inter gap-4 rounded-[5px]">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex flex-col items-center">
                    <span className="font-semibold text-xl">&#8377;5.4</span>
                    <span className="font-normal text-xs">Investment</span>
                  </div>
                </div>
            ...
            <div className="pb-[8.5rem] space-y-4 px-4">
              <div className="bg-white p-4 flex flex-col font-inter gap-4 rounded-[5px]">
                <div className="flex items-center gap-1">
