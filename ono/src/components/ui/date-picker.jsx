...
export function DateTimePicker({
  ...
  return (
    <div className="w-full">
      <button
        className="flex items-center justify-center w-full disabled:cursor-not-allowed bg-white transition-all duration-200 cursor-pointer touch-manipulation rounded-[5px] border border-[#CBCBCB] p-1.5"
        onClick={() => setIsOpen(!isOpen)}
        disabled={!disabled}
      >
        <img src={ClockIcon} className="h-4 w-4 text-[#1A7BFE]" alt="" />
        {/* <input
          type="text"
      ...
      {isOpen && (
        <div className="mb-16 fixed inset-0 z-50 flex items-center justify-center w-full">
          <div className="w-[90%] bg-white rounded-2xl shadow-xl border border-gray-200 p-4 sm:p-6 max-h-[90vh] overflow-y-auto scrollbar-hide">
            {renderCalendar()}
            {renderTimePicker()}
